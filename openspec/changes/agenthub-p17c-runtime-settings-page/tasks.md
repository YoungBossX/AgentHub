...
- [ ] 1.2 Add a compact runtime settings entry point from the chat workspace, using an icon/button/link that does not compete with the session list.
...
- [ ] 2.1 Add a dedicated runtime settings page or route for Planner, Frontend, Backend, and Review configuration.
...
- [ ] 3.1 Keep settings edits in draft state until Save is clicked.
